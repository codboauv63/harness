...
Tâche : Rédiger les décisions architecturales et l'ADR (Architecture Decision Record) pour la User Story ${state.userStoryId} du domaine ${state.boundedContext}.
